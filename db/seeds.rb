...
if Rails.env.eql?("development")
  ...
  Spree::AuthenticationMethod.create(environment: "production", provider: "facebook", api_key: "311692455936768", api_secret: "b01173a5069169f47de2d409719af2ee", active: true)
end
